...
public class main {
	...
	public static void main(String[] args) {
		...
		Cellulare telefono = new Cellulare(10);
		
		System.out.println("Il credito è di: "+telefono.numero404());
		telefono.ricarica(10);
		System.out.println("Il credito è di: "+telefono.numero404());
		telefono.chiama(2);
		telefono.chiama(2);
		System.out.println("Il credito è di: "+telefono.numero404());
		System.out.println("Il numero delle chiamate è: "+telefono.getNumeroChiamate());
